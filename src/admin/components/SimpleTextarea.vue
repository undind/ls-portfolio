...
.simple-textarea__control_error,
.simple-textarea__control_error:focus {
  border-color: $danger-color;
}

.simple-textarea__control_large {
  font-size: 18px;
  font-weight: 600;
  line-height: 44px;
